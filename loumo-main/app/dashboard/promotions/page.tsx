          ...
          <div className="flex gap-4 flex-wrap">
            ...
            <Select value={typeFilter} onValueChange={setTypeFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="Livraison gratuite">
                  Livraison gratuite
                </SelectItem>
              </SelectContent>
            </Select>
                              ...
                              <div>
                                ...
                                <div className="space-y-2 text-sm">
                                  ...
                                  <div>
                                    ...
                                    <div className="mt-1">
                                      {selectedPromotion.categories.map(
          ...
          <div className="space-y-6">
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input
                  id="name"
                  placeholder="Ex: Promo Ramadan 2024"
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <Select defaultValue={editingPromotion?.customers || "Tous"}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="Nouveaux clients">
                      Nouveaux clients
                    </SelectItem>
                    <SelectItem value="Clients fidèles">
                      Clients fidèles
                    </SelectItem>
                  </SelectContent>
                </Select>
              ...
              <div className="space-y-2">
                <Label htmlFor="newClientPeriod">
                  Période "nouveau client" (jours)
                </Label>
                <Input
                  id="newClientPeriod"
                  type="number"
                    ...
                    .map((category) => (
                      ...
                      >
                        <input
                          type="checkbox"
                          id={category}
                          defaultChecked={editingPromotion?.categories?.includes(
                            category
                          )}
                        />
            ...
            <div className="flex items-center space-x-2">
              <Switch
                id="isActive"
                defaultChecked={editingPromotion?.status === "Actif" ?? true}
              />
