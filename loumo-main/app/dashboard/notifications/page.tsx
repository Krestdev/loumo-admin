...
const notifications = [
  {
    ...
    message:
      "Le stock de Riz Brisé Premium 25kg est en dessous du seuil minimum (5 unités restantes)",
    type: "Alerte stock",
    priority: "Urgent",
  ...
  },
  {
    ...
    message:
      "Le paiement de 91.30€ pour la commande #ORD-004 a échoué (Fonds insuffisants)",
  ...
  },
  {
    ...
    message:
      "Ousmane Diop vient d'atteindre le statut VIP avec 3200 points de fidélité",
    type: "Fidélité",
    priority: "Info",
  ...
  },
  {
    ...
    message:
      "3 livraisons sont en retard dans la zone Almadies. Temps moyen de retard: 45 minutes",
...
const notificationRules = [
  {
    ...
    name: "Stock faible",
    description:
      "Alerte quand le stock d'un produit passe sous le seuil minimum",
  ...
  },
  {
    ...
    description:
      "Alerte quand une livraison dépasse le délai prévu de plus de 30 minutes",
    ...
    <main className="flex-1 overflow-auto p-4 space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {notifications.filter((n) => n.status === "Envoyé").length}
            </div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              Sur {notificationRules.length} règles
            </p>
          </CardContent>
        </Card>
      </div>
              ...
              <div className="flex gap-4 flex-wrap">
                ...
                <Select value={typeFilter} onValueChange={setTypeFilter}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="Nouvelle commande">
                      Nouvelle commande
                    </SelectItem>
                    <SelectItem value="Problème paiement">
                      Problème paiement
                    </SelectItem>
                    <SelectItem value="Problème livraison">
                      Problème livraison
                    </SelectItem>
                              ...
                              <div className="space-y-4">
                                ...
                                <div className="grid gap-4 md:grid-cols-2">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-sm mt-1">
                                      {notification.sentAt || "Non envoyé"}
                                    </p>
                                  </div>
                                </div>
        ...
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              {editingRule
                ...
                : "Créez une nouvelle règle de notification"}
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                id="trigger"
                placeholder="Ex: Stock < seuil minimum"
              ...
              <div className="grid gap-2 md:grid-cols-2">
                {[
                  ...
                  <div key={recipient} className="flex items-center space-x-2">
                    <Checkbox
                      id={recipient}
                      defaultChecked={editingRule?.recipients?.includes(
                        recipient
                      )}
                    />
              ...
              <div className="grid gap-2 md:grid-cols-3">
                {["Email", "SMS", "Dashboard", "Push"].map((channel) => (
                  <div key={channel} className="flex items-center space-x-2">
                    <Checkbox
                      id={channel}
                      defaultChecked={editingRule?.channels?.includes(channel)}
                    />
