      ...
      <main className="flex-1 overflow-auto p-4 space-y-6">
        ...
        {zoneData.isSuccess && (
          <div className="grid gap-4 md:grid-cols-4">
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{zoneData.data.length}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {zoneData.data.map((x) => x.addresses).flat().length}
                </div>
                <p className="text-xs text-muted-foreground">
                  Quartiers desservis
                </p>
                    ...
                    <TableRow key={zone.id}>
                      ...
                      <TableCell>
                        <div className="space-y-1">
                          {zone.addresses.map((neighborhood, index) => (
                            <Badge
                              key={index}
                              variant="outline"
                              className="mr-1 mb-1"
                      ...
                      <TableCell>
                        <div className="font-medium">
                          {zone.addresses
                            .flat()
                            .reduce(
                              (sum, addr) => sum + (addr.orders?.length ?? 0),
                              0
                            )}
                        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Visualisation des zones de livraison sur la carte
            </CardDescription>
          </CardHeader>
          <CardContent>
