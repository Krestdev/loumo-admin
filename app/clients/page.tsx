...
import { Search, Users, Star, ShoppingCart, MapPin, Phone, Mail, Calendar } from "lucide-react"
    ...
    <div className="flex h-screen flex-col">
      <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
        ...
        <div className="flex flex-1 items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">{"Gérez votre base de clients et leur fidélité"}</p>
          </div>
        </div>
      </header>
      ...
      <main className="flex-1 overflow-auto p-4 space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">{"Nouveaux clients (30j)"}</CardTitle>
                              ...
                              <CardContent className="space-y-4">
                                ...
                                <div className="space-y-2">
                                  ...
                                  <div className="flex items-center gap-2">
                                    ...
                                    <span>{"Client depuis le"} {selectedClient.joinDate}</span>
                                  </div>
                                </div>
                            ...
                            <Card>
                              ...
                              <CardContent className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                  ...
                                  <div className="text-center p-3 bg-muted rounded-lg">
                                    <div className="text-2xl font-bold">€{selectedClient.totalSpent.toFixed(0)}</div>
                                  ...
                                  <div className="text-center p-3 bg-muted rounded-lg">
                                    <div className="text-2xl font-bold">
                                      €{(selectedClient.totalSpent / selectedClient.totalOrders).toFixed(0)}
                                    </div>
