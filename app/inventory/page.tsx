...
import { Search, Download, AlertTriangle, Package, Calendar } from "lucide-react"
...
export default function InventoryPage() {
  ...
  const filteredData = inventoryData.filter((item) => {
    ...
    const matchesThreshold = selectedThreshold === "all" || item.status === selectedThreshold
      ...
      <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
        ...
        <div className="flex flex-1 items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">{"Suivi des stocks et approvisionnements"}</p>
          </div>
          <Button>
              ...
              <div className="space-y-2">
                ...
                <Select value={selectedProduct} onValueChange={setSelectedProduct}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="Riz Brisé 25kg">{"Riz Brisé 25kg"}</SelectItem>
                    <SelectItem value="Huile Tournesol 5L">{"Huile Tournesol 5L"}</SelectItem>
                    <SelectItem value="Savon Marseille x12">{"Savon Marseille x12"}</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Select value={selectedThreshold} onValueChange={setSelectedThreshold}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="critique">{"Critique (&lt;10%)"}</SelectItem>
              ...
              <TableBody>
                {filteredData.map((item) => (
                  <TableRow key={item.id}>
                    ...
                    <TableCell>{format(new Date(item.lastRestock), "dd/MM/yyyy", { locale: fr })}</TableCell>
