                    ...
                    <TableRow key={reward.id}>
                      ...
                      <TableCell>
                        {reward.stock === null ? (
                          ...
                          <span
                            className={reward.stock === 0 ? "text-red-600" : ""}
                          >
                            {reward.stock}
                          </span>
                        )}
      ...
      <Dialog open={isSettingsOpen} onOpenChange={setIsSettingsOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Configurez les règles et taux du programme
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input
                  id="pointsPerEuro"
                  type="number"
                  defaultValue={loyaltySettings.pointsPerEuro}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  type="number"
                  step="0.01"
                  defaultValue={loyaltySettings.euroPerPoint}
                />
              </div>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  type="number"
                  defaultValue={loyaltySettings.minimumRedemption}
                />
              </div>
              <div className="space-y-2">
                <Label htmlFor="pointsExpiry">
                  Expiration des points (jours)
                </Label>
                <Input
                  id="pointsExpiry"
                  type="number"
                  defaultValue={loyaltySettings.pointsExpiry}
                />
              </div>
            </div>
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <div className="space-y-2">
                  ...
                  <Input
                    id="welcomeBonus"
                    type="number"
                    defaultValue={loyaltySettings.welcomeBonus}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    id="birthdayBonus"
                    type="number"
                    defaultValue={loyaltySettings.birthdayBonus}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    id="referralBonus"
                    type="number"
                    defaultValue={loyaltySettings.referralBonus}
                  />
                </div>
              </div>
            </div>
      ...
      <Dialog open={isRewardDialogOpen} onOpenChange={setIsRewardDialogOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              {editingReward
                ? "Modifiez les détails de la récompense"
                : "Créez une nouvelle récompense"}
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-2">
              <Switch
                id="rewardActive"
                defaultChecked={editingReward?.isActive ?? true}
              />
