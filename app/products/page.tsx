                ...
                <Dialog open={bulkEditOpen} onOpenChange={setBulkEditOpen}>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      ...
                      <DialogDescription>Modifiez plusieurs produits en même temps</DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4">
                      ...
                      <div className="flex gap-2">
                        <Button onClick={() => setBulkEditOpen(false)}>Appliquer les modifications</Button>
                  ...
                  <TableRow key={product.id}>
                    ...
                    <TableCell>
                      <div className="space-y-1">
                        <p className="font-medium">{getTotalStock(product.stock)} unités</p>
                    ...
                    <TableCell>
                      <Badge variant={getStatusColor(product.status)}>
                        {product.status === "Stock faible" && <AlertTriangle className="mr-1 h-3 w-3" />}
                        {product.status}
                      </Badge>
                    </TableCell>
                    <TableCell>
                ...
                <div className="grid gap-4 md:grid-cols-3">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      type="number"
                      placeholder="45"
                      defaultValue={editingProduct?.stock?.["Boutique Plateau"] || ""}
                    />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="stockParcelles">Stock Boutique Parcelles</Label>
                    <Input
                      id="stockParcelles"
                      type="number"
                      placeholder="32"
                      defaultValue={editingProduct?.stock?.["Boutique Parcelles"] || ""}
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      type="number"
                      placeholder="18"
                      defaultValue={editingProduct?.stock?.["Boutique Almadies"] || ""}
                    />
                  </div>
                </div>
              </div>
